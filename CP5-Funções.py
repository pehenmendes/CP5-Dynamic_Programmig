...
medir_tempo(qtdeMoedas, M, [1, 3, 4]) 
medir_tempo(qtdeMoedas, M, [1, 2, 5])  


# FUNÇÃO 2 - Função Recursiva Pura (sem memoização)
...
medir_tempo(qtdeMoedasRec, M, [1, 3, 4])
medir_tempo(qtdeMoedasRec, M, [1, 2, 5])
...
medir_tempo(qtdeMoedasRecMemo, M, [1, 3, 4])
medir_tempo(qtdeMoedasRecMemo, M, [2, 4]) 


# FUNÇÃO 4 - Função Usando Programação Dinâmica (Bottom up)
...
medir_tempo(qtdeMoedasPD, M, [1, 3, 4])
medir_tempo(qtdeMoedasPD, M, [1, 2, 5])
